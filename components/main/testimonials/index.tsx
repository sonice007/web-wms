...
export default function TestimonialsPage() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content:
        "Sejak menjual produk di marketplace Warehouse MS, penjualan saya meningkat drastis. Ada banyak dukungan dan promosi yang membantu UMKM seperti saya.",
    },
    {
      id: 3,
      name: "Rudi, 55",
      ...
      <section className="px-6 lg:px-12 py-20 bg-gradient-to-b from-white to-[#6B6B6B]/10">
        <div className="container mx-auto text-center">
          ...
          >
            ...
            manfaat bergabung dengan Warehouse MS.
          </motion.p>
