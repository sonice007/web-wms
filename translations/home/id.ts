const translations = {
  ...
  "hero-title-3": "dengan Warehouse MS",
  "hero-subtitle":
  ...
  "cta-subtitle":
    "Rasakan kelembapan, kecerahan, dan kesehatan kulit bersama Warehouse MS. Temukan produk yang cocok untuk kebutuhan kulitmu.",
